  ...
  return(
    <div id='skillsCard' className="skills w-full h-full lg:flex lg:justify-center lg:flex-col"> 
      <div >
        ...
        <div className="w-full h-2/4 lg:h-24 flex gap-8 flex-wrap overflow-hidden justify-center mt-6 2xl:mt-8">
          ...
          <CardImage url='https://firebasestorage.googleapis.com/v0/b/portafolio-fac1a.appspot.com/o/skills%2Freact.svg?alt=media&token=176d01b0-b833-4e16-8e5f-0f0a7338440f' name='React Native'/>
      ...
      <div>
        ...
        <div className="w-full h-2/4 lg:h-24 flex gap-6 flex-wrap overflow-hidden justify-center mt-6 2xl:mt-8">
