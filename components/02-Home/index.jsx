...
export default function HomeCard(){
  ...
  return(
    <div id='section' className="w-full h-full  flex flex-col md:justify-between md:flex-row overflow-hidden pb-1">
      <div id='section1' className='md:hidden w-1/2 mt-14 ml-24'>
        <img
      ...
      <div id='section2' className="md:w-1/2">
        <h1 
          className="text-2xl md:text-5xl font-black tracking-wide mt-8 md:mt-44 ml-6 uppercase text-center text-[#a87dcc]"
        >
          Full Stack developer
        </h1>
        <h3 className="text-2xl font-bold mt-2 text-center text-white">Buenos Aires(CABA)</h3>
        <div className="flex gap-8 mt-6 ml-28 md:ml-60 text-[#a87dcc]">
          <Link 
            href=''
